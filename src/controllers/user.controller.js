...
module.exports.activeUser = async (req, res) => {
    try {
        let payload = await userService.changeUserActiveStatus(req.body.user_id, req.body.role_id, constants.ACTIVE);
        successResponse(
            res,
            constants.STATUS_SUCCESS,
            payload
...
module.exports.deactiveUser = async (req, res) => {
    try {
        let payload = await userService.changeUserActiveStatus(req.body.user_id, req.body.role_id, constants.NOT_ACTIVE);
        successResponse(
            res,
            constants.STATUS_SUCCESS,
            payload
