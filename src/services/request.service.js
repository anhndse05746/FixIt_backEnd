...
module.exports.getListRequestByStatusForCustomer = async (customer_id, role, pageNo, status_id) => {
    let page = (pageNo - 1) * 5;
...
module.exports.getInitListRequest = async (customer_id, role) => {
    ...
    //Processing request
    let listProcessingRequest = await RequestRepo.getListRequestByStatusForCustomer(customer_id, role, 0, [constants.STATUS_REQUEST_HASTAKEN, constants.STATUS_REQUEST_FIXING, constants.STATUS_REQUEST_FIXED]);
